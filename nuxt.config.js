...
module.exports = {
  ...
  */
  head: {
    title: 'Природний заповідник "Дніпровсько-Орільський"',
    meta: [
      { charset: 'utf-8' },
    ...
    script: [
      { src: 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAgePCfKDNY16GzsMB9k-GJCi3YrbexORA&libraries=drawing'},
